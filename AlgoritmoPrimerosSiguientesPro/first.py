...
first = calcular_first(gramatica_inicial)
follow = calcular_follow(gramatica_inicial, first)
produccion_tabla = calcular_produccion(gramatica_inicial, first, follow)
